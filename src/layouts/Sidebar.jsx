...
import LetterGlitch from '../components/LetterGlitch'; import Header from "../components/Header";
;
const Sidebar = () => {
          ...
          <ul className="mt-6 space-y-1">
            ...
            <li>
              ...
              >
                ...
                />
                <h1 className="cursor-pointer">aboutme</h1>

              </p>
              <h1 className="block rounded-lg py-2 text-2xl text-neutral-600 font-bold hover:text-gray-500 transition">  Topics:-</h1>
            </li>
            ...
            <li>
              ...
              <Link
                to="/useeffect" onClick={() => setIsOpen(false)}
                className={`${location.pathname === '/useeffect' ? 'text-[#57C4DC]' : 'text-white'} block rounded-lg py-2 font-medium hover:text-gray-500 transition`}
              >
                useEffect()
              </Link>
            </li>
