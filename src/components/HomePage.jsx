...
const HomePage = () => {
  return (
    <div className=" text-xl w-full h-full flex flex-col items-center justify-center py-32 md:py-12">
      ...
      <svg
        ...
        className="animate-spinSlow text-[#57C4DC] w-[150px] relative z-10"
      >
      ...
      <p className="mt-12 text-2xl font-bold text-[#57C4DC] max-w-[35ch] text-center mix-blend-plus-lighter relative z-10">
